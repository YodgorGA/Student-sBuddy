...
<html lang="ru">
  ...
  <body>
    ...
    <div class='container-fluid'>
      <div class='row justify-content-center'>
      <div class='col-2'>
        <button class="btn btn-dark w-100" type="button" data-bs-toggle="collapse" data-bs-target="#new_mark" aria-expanded="false" aria-controls="new_mark">Добавить оценку</button>
      </div>
      <div class='col-2'>
